...
const whoWinnerElem = document.getElementById('js-whoWinnerElement');
      whoWinnerInfo = document.getElementById('js-whoWinnerInfo');
...
function setGameElements() {
    ...
    case 'started':
        ...
        whoWinnerElem.style.display = 'none';
        break;
    case 'ended':
        whoWinnerElem.style.display = 'block';
...
function playerPick(playerPick) {
    ...
    if (computer.score == 10) {
        gameState = 'ended';
        setGameElements();
        whoWinnerInfo.innerHTML = "Computer"
      }
    else if  (player.score == 10) {
        gameState = 'ended';
        setGameElements();
        whoWinnerInfo.innerHTML = player.name;
      }
}
